...
var requireUserCountWithinTime = function(userCount, timeLimit) {
    return {
        description: "Лифты перевозят <span class='emphasis-color'>" + userCount + "</span> человек.",// in <span class='emphasis-color'>" + timeLimit.toFixed(0) + "</span> seconds or less",
...
var challenges = [
     {options: {floorCount: 16, elevatorCount: 4, spawnRate: 2}, condition: requireUserCountWithinTime(200, 3600)}
